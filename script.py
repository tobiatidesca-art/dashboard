...
def get_optimized_data():
    print("🚀 Recupero dati e generazione tabella...")
...
<head>
    ...
    <style>
        ...
        .live-tile {{ background: #000000; padding: 15px; border-radius: 10px; border: 1px solid #3b82f6; min-width: 150px; text-align: center; }}
        .live-value {{ font-size: 1.4rem; font-weight: 800; color: #ffffff; display: block; }}
        ...
        input {{ background: #ffffff !important; color: #000000 !important; font-weight: 900; font-size: 1.2rem; text-align: center; border: 2px solid #3b82f6 !important; width: 100%; }}
        .table {{ color: #e5e7eb; margin-top: 10px; }}
        .table thead th {{ border-bottom: 2px solid #3b82f6; color: #60a5fa; }}
    </style>
</head>
<body class="p-4">
    <div class="container-fluid">
        <div class="header-main">
            ...
            <div class="d-flex justify-content-between gap-2 mt-4 flex-wrap">
                ...
                <div class="live-tile" style="border-color:#10b981"><span class="small" style="color:#10b981">MOMENTUM LIVE</span><span class="live-value" style="color:#10b981">{(live['MOM_LIVE']*100):+.2f}%</span></div>
            </div>
        </div>
        ...
        <div class="card-pro">
            <h5 class="fw-bold text-info mb-3">Registro Ultime Operazioni</h5>
        ...
        function runAnalysis() {{
            ...
            myChart = new Chart(ctx, {{
                ...
                options: {{ 
                    ...
                    scales: {{ x: {{ ticks: {{ color: '#9ca3af', maxRotation: 45, minRotation: 45 }} }}, y: {{ ticks: {{ color: '#9ca3af' }} }} }}
                }}
            }});
        }}
...
try:
    ...
    repo.update_file(contents.path, "Aggiornamento con Tabella Operazioni", html_content, contents.sha, branch="main")
    print("✅ Sito aggiornato con successo!")
